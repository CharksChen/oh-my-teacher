...
>
> ## SRS Update
> 数列极限-εN证明, score 4, streak 0 → next review 2026-06-08
...
> 今日到期主题（2026-06-07）：
>
> | Topic | Last Review | Score | Streak | Next Review | Overdue Days |
> |-------|-------------|-------|--------|-------------|--------------|
> | 数列极限-εN证明 | 2026-06-01 | 4 | 0 | 2026-06-02 | 5 |
>
> 建议：对"数列极限-εN证明"做一次 `/quiz` 复习，巩固 ε-N 证明中 N 的取法。
